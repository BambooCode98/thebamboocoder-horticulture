...
function Id({ posts , pages  }) {
    ...
    let garden = posts.filter((post)=>{
        return post.frontmatter.category === "gardening" || post.frontmatter.category === "all";
    });
...
async function getStaticProps() {
    ...
    const posts = files.map((file)=>{
        ...
        //get front matter
        const frontMatter = fs__WEBPACK_IMPORTED_MODULE_2___default().readFileSync(path__WEBPACK_IMPORTED_MODULE_3___default().join("gardening", file), "utf-8");
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,517,510], () => (__webpack_exec__(4972)));
