...
function Id({ posts , pages  }) {
    ...
    let forestry = posts.filter((post)=>{
        return post.frontmatter.category === "forestry" || post.frontmatter.category === "all";
    });
...
async function getStaticPaths() {
    ...
    const files = fs__WEBPACK_IMPORTED_MODULE_2___default().readdirSync(path__WEBPACK_IMPORTED_MODULE_3___default().join("forestry"));
...
async function getStaticProps() {
    ...
    const posts = files.map((file)=>{
        ...
        //get front matter
        const frontMatter = fs__WEBPACK_IMPORTED_MODULE_2___default().readFileSync(path__WEBPACK_IMPORTED_MODULE_3___default().join("forestry", file), "utf-8");
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,517,510], () => (__webpack_exec__(1981)));
