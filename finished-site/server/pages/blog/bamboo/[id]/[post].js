...
async function getStaticProps({ params: { post  }  }) {
    ...
    // console.log(post);
    const markdownContent = fs__WEBPACK_IMPORTED_MODULE_2___default().readFileSync(path__WEBPACK_IMPORTED_MODULE_3___default().join("bamboo", post + ".md"), "utf-8");
...
var __webpack_exports__ = __webpack_require__.X(0, [321], () => (__webpack_exec__(1139)));
