            ...
            children: [
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_head__WEBPACK_IMPORTED_MODULE_6___default()), {
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("title", {
                        children: "Bamboo Blog Posts"
                    })
                }),
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h1", {
                    className: "blog-title",
                    children: "Bamboo Articles"
                }),
...
async function getStaticProps() {
    ...
    const files = fs__WEBPACK_IMPORTED_MODULE_2___default().readdirSync(path__WEBPACK_IMPORTED_MODULE_3___default().join("bamboo"));
    //get slug and front matter from posts
    const posts = files.map((file)=>{
        //create slug first
        const slug = file.replace(".md", "");
        //get front matter
        const frontMatter = fs__WEBPACK_IMPORTED_MODULE_2___default().readFileSync(path__WEBPACK_IMPORTED_MODULE_3___default().join("bamboo", file), "utf-8");
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,517,510], () => (__webpack_exec__(2595)));
